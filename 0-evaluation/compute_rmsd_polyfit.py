...
poly_dir = '/media/y/18T/parallelism_2022/revision_exper/{}/comparison/Polyfit/poly'.format(this_type)
tri_dir = '/media/y/18T/parallelism_2022/revision_exper/{}/comparison/Polyfit/tri'.format(this_type)
tri_rb_dir = '/media/y/18T/parallelism_2022/revision_exper/{}/comparison/Polyfit/tri_rb'.format(this_type)
r2s_dir = '/media/y/18T/parallelism_2022/revision_exper/{}/comparison/Polyfit/r2s'.format(this_type)
s2r_dir = '/media/y/18T/parallelism_2022/revision_exper/{}/comparison/Polyfit/s2r'.format(this_type)
rmsd_dir = '/media/y/18T/parallelism_2022/revision_exper/{}/comparison/Polyfit/rmsd'.format(this_type)
