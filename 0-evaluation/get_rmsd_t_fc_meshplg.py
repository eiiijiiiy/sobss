...
time = np.loadtxt('{}/{}/comparison/Meshplg/log.txt'.format(root_dir, t))
rmsd = np.loadtxt('{}/{}/comparison/Meshplg/rmsd.txt'.format(root_dir, t))
mesh_dir = '{}/{}/comparison/Meshplg/poly'.format(root_dir, t)
output_path = '{}/{}/comparison/Meshplg/param_sta.txt'.format(root_dir, t)
...
for i in range(sample_num):
    sample_mesh_path = '{}/{}.off-result.ply'.format(mesh_dir, names[i])
