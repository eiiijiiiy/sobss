...
poly_dir = '/media/y/18T/parallelism_2022/revision_exper/{}/comparison/25D_Dual/obj_1m_1'.format(this_type)
tri_dir = '/media/y/18T/parallelism_2022/revision_exper/{}/comparison/25D_Dual/tri'.format(this_type)
tri_rb_dir = '/media/y/18T/parallelism_2022/revision_exper/{}/comparison/25D_Dual/tri_rb'.format(this_type)
r2s_dir = '/media/y/18T/parallelism_2022/revision_exper/{}/comparison/25D_Dual/r2s'.format(this_type)
s2r_dir = '/media/y/18T/parallelism_2022/revision_exper/{}/comparison/25D_Dual/s2r'.format(this_type)
rmsd_path = '/media/y/18T/parallelism_2022/revision_exper/{}/comparison/25D_Dual/rmsd.txt'.format(this_type)
