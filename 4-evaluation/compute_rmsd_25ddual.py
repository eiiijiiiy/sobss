...
poly_dir = '{}/{}/comparison/25D_Dual/obj_1m_1'.format(root_dir,this_type)
tri_dir = '{}/{}/comparison/25D_Dual/tri'.format(root_dir,this_type)
tri_rb_dir = '{}/{}/comparison/25D_Dual/tri_rb'.format(root_dir,this_type)
r2s_dir = '{}/{}/comparison/25D_Dual/r2s'.format(root_dir,this_type)
s2r_dir = '{}/{}/comparison/25D_Dual/s2r'.format(root_dir,this_type)
rmsd_path = '{}/{}/comparison/25D_Dual/rmsd.txt'.format(root_dir,this_type)
