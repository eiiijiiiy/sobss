...
time = np.loadtxt('{}/{}/comparison/25D_Dual/log_1m_1.txt'.format(root_dir, t))
rmsd = np.loadtxt('{}/{}/comparison/25D_Dual/rmsd.txt'.format(root_dir, t))
mesh_dir = '{}/{}/comparison/25D_Dual/obj_1m_1'.format(root_dir, t)
output_path = '{}/{}/comparison/25D_Dual/param_sta.txt'.format(root_dir, t)
